    ...
    try {
        if (req.body.room_id) {
            ...
            if (checkRoom.length === 0) {
                ...
                // Fetch list of unassigned rooms
            ...
            // Update queue for rooms that are not assigned
            let roomNotAssigned = await query(`SELECT * FROM room WHERE is_assign = false AND queue = false ORDER BY id ASC`);
